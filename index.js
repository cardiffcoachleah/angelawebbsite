...
// TODO: Replace with Angela's actual Calendly URLs
...
export default function Home() {
  return (
    <Layout
      description="Coaching for people who are ready to trust themselves and move forward with clarity."
    >

      {/* ── HERO ─────────────────────────────────────────────────── */}
      <section className="relative h-[90vh] min-h-[560px] flex items-center justify-center">
        <Image
          ...
          priority
        />
        {/* Gradient overlay — darker at bottom for smooth transition to white */}
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          <h1 className="font-serif text-white text-4xl md:text-6xl lg:text-7xl font-light leading-tight">
            What if being{' '}
            <em className="font-serif-italic">full of yourself</em>{' '}
          ...
          <div className="mt-10">
            <Link
              ...
              className="inline-block bg-white text-charcoal font-sans text-sm tracking-widest uppercase px-10 py-4 hover:bg-silver transition-colors"
            >
      ...
      <section className="bg-white py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            {/* Copy */}
            <div>
              <p className="font-serif text-2xl md:text-3xl text-charcoal font-light leading-relaxed italic mb-8">
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="relative w-72 h-80 md:w-80 md:h-96 rounded-sm overflow-hidden">
                <Image
      ...
      {/* ── COACHING FOR PEOPLE READY TO... ─────────────────────── */}
      <section className="bg-silver/30 py-20 md:py-24">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="w-12 h-px bg-plum mx-auto mb-12" />

          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 text-left">
            {coachingReadyItems.map((item, i) => (
              <div key={i} className="flex items-start gap-3">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-plum flex-shrink-0" />
          ...
          <div className="mt-14">
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-plum text-white font-sans text-sm tracking-widest uppercase px-10 py-4 hover:bg-plum-dark transition-colors"
            >
              Book a Free Discovery Call
            </Link>
          </div>
      ...
      {/* ── STORY TEASER ─────────────────────────────────────────── */}
      <section className="bg-blue-DEFAULT py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-6">
